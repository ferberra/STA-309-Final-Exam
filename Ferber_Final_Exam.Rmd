...
knitr::opts_chunk$set(
  ...
  results = 'asis'    # Show only outputs/plots
)
...
# Save plot
ggsave("song_length_plot.png", song_length_plot, width = 12, height = 8)
...
# Save plot
ggsave("cover_plot.png", cover_plot, width = 12, height = 8)
...
# Save plot
ggsave("explicit_plot.png", explicit_plot, width = 12, height = 8)
...
# Save plot
ggsave("artist_gender_plot.png", artist_gender_plot, width = 12, height = 8)
...
# Save plot
ggsave("media_plot.png", media_plot, width = 12, height = 8)
...
Implications:
Based on the results of this analysis, we can determine that the songs that are the most statistically likely to last the longest at number one are original, not made-for-media, explicit songs by co-ed bands between 4-6 minutes long. With this knowledge, music production corporations can optimize their profits by pigeon-holing their focus into a particular market of interest.
